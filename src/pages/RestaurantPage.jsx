...
export default function RestaurantPage({ name, propertyId }) {
  ...
  return (
    ...
    >
      <FacilityPage
        ...
        heroImage={loading ? '/restaurant-placeholder.jpg' : restaurantData?.photos?.[0] || restaurant1}
        extraTopElement={
        ...
        descriptionText={loading ? 'Loading restaurant details...' : restaurantData?.about || ''}
        infoSectionProps={{
        ...
        infoModalDescription={`Indulge in a culinary journey at ${name}, where local flavors meet elegance.`}
        infoModalTitle="Menu"
        slideshowImages={restaurantData?.photos || [restaurant2, restaurant1, restaurant3, restaurant4]}
        fetchUrl={fetchUrl}
        ctaLabel="Menu"
        dataSelector={data => {
          const matched = Array.isArray(data)

  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-start md:items-center">
      <motion.div
        ...
        className="bg-white w-full min-h-[var(--app-height)] md:h-auto md:max-h-[95vh] overflow-y-auto relative p-6 rounded-none md:rounded-lg shadow-lg md:max-w-6xl mx-auto"
      >
        <button
          onClick={onClose}
        ...
        <div className="mt-6 flex justify-center">
          <button
            className="bg-black text-white text-m font-light px-8 py-4"
